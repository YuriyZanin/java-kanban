...
public class TestData {
    ...
    public static final Task SIMPLE_TASK_1 = new Task(SIMPLE_TASK_1_ID, "Simple1", Status.NEW, "simple task 1");
    public static final Task SIMPLE_TASK_2 = new Task(SIMPLE_TASK_2_ID, "Simple2", Status.NEW, "simple task 2");
    public static final List<Task> SIMPLE_TASKS = List.of(SIMPLE_TASK_1, SIMPLE_TASK_2);
    public static final Epic EPIC_TASK_1 = new Epic(EPIC_TASK_1_ID, "Epic1", Status.NEW, "epic task 1");
    public static final SubTask SUB_TASK_1 = new SubTask(SUB_TASK_1_ID, "SubTask1", Status.NEW, "sub task 1", EPIC_TASK_1.getId());
    public static final SubTask SUB_TASK_2 = new SubTask(SUB_TASK_2_ID, "SubTask2", Status.NEW, "sub task 2", EPIC_TASK_1.getId());
    public static final SubTask SUB_TASK_3 = new SubTask(SUB_TASK_3_ID, "SubTask3", Status.NEW, "sub task 3", EPIC_TASK_1.getId());
    public static final List<SubTask> SUB_TASKS = List.of(SUB_TASK_1, SUB_TASK_2, SUB_TASK_3);
    public static final Epic EPIC_TASK_2 = new Epic(EPIC_TASK_2_ID, "Epic1", Status.NEW, "epic task 1");
