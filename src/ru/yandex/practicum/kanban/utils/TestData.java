...
public class TestData {
    ...
    public static final Task SIMPLE_TASK_1 = new Task(SIMPLE_TASK_1_ID, "Simple1", Status.NEW, "simple task 1", LocalDateTime.of(NEXT_DAY, LocalTime.of(12, 0)), TaskInterval.DEFAULT_DURATION);
    public static final Task SIMPLE_TASK_2 = new Task(SIMPLE_TASK_2_ID, "Simple2", Status.NEW, "simple task 2", LocalDateTime.of(NEXT_DAY, LocalTime.of(12, 15)), TaskInterval.DEFAULT_DURATION);
    ...
    public static final SubTask SUB_TASK_1 = new SubTask(SUB_TASK_1_ID, "SubTask1", Status.NEW, "sub task 1", LocalDateTime.of(NEXT_DAY, LocalTime.of(12, 30)), TaskInterval.DEFAULT_DURATION, EPIC_TASK_1.getId());
    public static final SubTask SUB_TASK_2 = new SubTask(SUB_TASK_2_ID, "SubTask2", Status.NEW, "sub task 2", LocalDateTime.of(NEXT_DAY, LocalTime.of(12, 45)), TaskInterval.DEFAULT_DURATION, EPIC_TASK_1.getId());
    public static final SubTask SUB_TASK_3 = new SubTask(SUB_TASK_3_ID, "SubTask3", Status.NEW, "sub task 3", LocalDateTime.of(NEXT_DAY, LocalTime.of(13, 0)), TaskInterval.DEFAULT_DURATION, EPIC_TASK_1.getId());
    public static final List<SubTask> SUB_TASKS = List.of(SUB_TASK_1, SUB_TASK_2, SUB_TASK_3);
    public static final List<Task> PRIORITIZED_TASKS = List.of(SIMPLE_TASK_1, SIMPLE_TASK_2, SUB_TASK_1, SUB_TASK_2, SUB_TASK_3);
